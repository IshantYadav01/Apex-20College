        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="lg:col-span-2 bg-white shadow-lg overflow-hidden group cursor-pointer">
            ...
            <div className="bg-apex-bg-gray p-6 h-[362px] flex flex-col">
              <p className="text-[30px] font-medium opacity-60 mb-2">
                Bachelor in
              </p>
              <h3 className="text-[35px] font-medium opacity-60 mb-4">
              ...
              <Link
                to="/"
                className="text-xl font-medium flex items-center gap-2 group/link"
              >
                Read more
                <svg
                  width="23"
