        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          <div className="lg:col-span-2 bg-white shadow-md overflow-hidden group cursor-pointer h-full">
            ...
            <div className="bg-apex-bg-gray p-6 h-[362px] flex flex-col">
              <p className="text-[30px] font-medium text-black opacity-60 mb-2">Bachelor in</p>
              <h3 className="text-[35px] font-medium text-black opacity-60 mb-4">Business Administration</h3>
              ...
              <Link to="/" className="text-xl font-medium text-black flex items-center gap-2 group/link mt-4">
                Read more
          ...
          <div className="bg-white shadow-md overflow-hidden group cursor-pointer">
            <div className="h-[480px] overflow-hidden">
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/10d5cef435c73acc1a3d410f8a7257b890083799?width=530" alt="Program" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
            </div>
          </div>

          <div className="bg-white shadow-md overflow-hidden group cursor-pointer">
            <div className="h-[480px] overflow-hidden">
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/4833c3bdb07d1626f7a65926d705077034aae0ef?width=530" alt="Program" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
            </div>
          </div>

          <div className="bg-white shadow-md overflow-hidden group cursor-pointer">
            <div className="h-[480px] overflow-hidden">
              <img src="https://api.builder.io/api/v1/image/assets/TEMP/5de439b9f4c7eb83cf8075f5e7506854de28ea35?width=528" alt="Program" className="w-full h-full object-cover group-hover:scale-105 transition-transform duration-300" />
            </div>
          </div>
        </div>
      </div>
