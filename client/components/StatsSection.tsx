export default function StatsSection() {
  const stats = [
    { number: "6", title: "Academic Programs", subtitle: "Comprehensive undergraduate degree" },
    { number: "10", title: "Student Clubs", subtitle: "Comprehensive undergraduate degree" },
    { number: "18", title: "Centers & Labs", subtitle: "State-of-the-art facilities" },
    { number: "1,707", title: "Students On Campus", subtitle: "Active Learning Community" },
    { number: "150", title: "Faculty Members", subtitle: "Experience educators and researchers" },
    { number: "96%", title: "Success Rate", subtitle: "Be industry ready with skills" },
  ];
