  ...
  const stats = [
    ...
    },
    {
      icon: (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
          <path
            d="M20 13.3521C20 12.7282 20.2107 12.13 20.5858 11.6889C20.9609 11.2478 21.4696 11 22 11H32C32.5304 11 33.0391 11.2478 33.4142 11.6889C33.7893 12.13 34 12.7282 34 13.3521V19.2322C34 21.4155 33.2625 23.5094 31.9497 25.0532C30.637 26.597 28.8565 27.4644 27 27.4644C25.1435 27.4644 23.363 26.597 22.0503 25.0532C20.7375 23.5094 20 21.4155 20 19.2322V13.3521ZM24 34.5205H30L27 28.6404L24 34.5205Z"
            stroke="black"
            strokeWidth="2"
            strokeLinecap="round"
    ...
    },
    {
      icon: (
        <svg width="17" height="24" viewBox="0 0 17 24" fill="none">
          <path
            d="M11.8888 18.0313L12.0619 21.7071L8.50988 19.1233L4.93792 21.7095L5.11121 18.0313H3.61106L3.3525 23.5205H5.07052L8.50791 21.0318L11.9294 23.5205H13.6475L13.3889 18.0313H11.8888Z"
            fill="black"
          />
        </svg>
      ),
