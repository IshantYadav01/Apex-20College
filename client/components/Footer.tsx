  ...
  return (
    <footer className="bg-apex-gray text-white">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-8">
          <div>
            ...
            <div className="mt-6 space-y-1 text-xl font-medium">
              <a href="tel:+977-4578841" className="block underline hover:text-apex-orange">+977-4578841</a>
              <a href="tel:9851079266" className="block underline hover:text-apex-orange">9851079266</a>
              <a href="tel:9801299922" className="block underline hover:text-apex-orange">9801299922</a>
              <a href="mailto:admissions@apexcollege.edu.np" className="block underline hover:text-apex-orange">admissions@apexcollege.edu.np</a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-xl underline">
              <li><Link to="/" className="hover:text-apex-orange">Our Programs</Link></li>
              <li><Link to="/" className="hover:text-apex-orange">University Partner</Link></li>
              <li><Link to="/" className="hover:text-apex-orange">PU Notice</Link></li>
              <li><Link to="/" className="hover:text-apex-orange">About ING</Link></li>
            </ul>
          </div>

          <div>
            <ul className="space-y-2 text-xl underline mt-12">
              <li><Link to="/" className="hover:text-apex-orange">Admission</Link></li>
              <li><Link to="/" className="hover:text-apex-orange">News and Updates</Link></li>
              <li><Link to="/" className="hover:text-apex-orange">Career at Apex</Link></li>
              <li><Link to="/" className="hover:text-apex-orange">International Scholarship</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="#" className="hover:text-apex-orange transition-colors" aria-label="LinkedIn">
              ...
              <a href="#" className="hover:text-apex-orange transition-colors" aria-label="Facebook">
                <svg width="11" height="18" viewBox="0 0 11 18" fill="none" stroke="currentColor" strokeWidth="4">
                  <path d="M9.00004 2H7.44448C5.50004 2 4.33337 3.30698 4.33337 5.48527V15.9411" strokeLinecap="round" strokeLinejoin="round"/>
                  <path d="M2 8.97363H7.44444" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </a>
              <a href="#" className="hover:text-apex-orange transition-colors" aria-label="Instagram">
              ...
              <a href="#" className="hover:text-apex-orange transition-colors" aria-label="YouTube">
      ...
      <div className="border-t border-[#7C7575] py-4 text-center">
        <p className="text-xl text-[#7C7575]">Copyright ©2025 All rights reserved</p>
      </div>
    </footer>
  );
}
