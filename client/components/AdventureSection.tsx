  ...
  const cards = [
    {
      bg: "bg-apex-gray",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/4e650d72bdcf05b4c55756f62a8a6c75fab7219b?width=1910",
      title: "Centers & Labs",
    ...
    },
    {
      bg: "bg-apex-maroon",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/7ee58f44dd13e1244e54ac99021d4e2819649d6a?width=1336",
    ...
    },
    {
      bg: "bg-apex-gray",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/3bd24244bdcb1589a90c648f6d6234d9cdb0a0da?width=1914",
      title: "Student Clubs",
      description:
    ...
    },
    {
      bg: "bg-apex-maroon",
      image:
        "https://api.builder.io/api/v1/image/assets/TEMP/865cc3d718981b2d4b3d723292a291453c80c0e5?width=1824",
